...
const config = {
  ...
  tagline: 'An innovative guide to Physical AI, embodied intelligence, and humanoid robotics',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Interactive AI-Driven Physical AI & Humanoid Robotics Book. Built with Docusaurus.`,
      },
      prism: {
